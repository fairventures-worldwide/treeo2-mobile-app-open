package org.treeo.treeo.ui.terms
...
import org.treeo.treeo.databinding.FragmentTermsBinding

private const val isPrivacyPolicy = "is_privacy_policy"

class TermsFragment : Fragment() {
    private var isPrivacyPolicyPage: Boolean? = false
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbar.apply {
            ...
            if (isPrivacyPolicyPage == true) {
                pageTitle.text = context.getString(R.string.privacy_policy)
            } else {
                pageTitle.text = context.getString(R.string.terms_of_use)
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            isPrivacyPolicyPage = it.getBoolean(isPrivacyPolicy)
        }
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(isPrivacyPage: Boolean) =
            TermsFragment().apply {
                arguments = Bundle().apply {
                    putBoolean(isPrivacyPolicy, isPrivacyPage)
...
private const val privacyPolicy = "<h1>Privacy Policy for Treeo</h1>\n" +
        "\n" +
        "<p>At treeo.org, accessible from https://treeo.org, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by treeo.org and how we use it.</p>\n" +
        "\n" +
        "<p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>\n" +
        "\n" +
        "<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in treeo.org. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a href=\"https://www.termsfeed.com/privacy-policy-generator/\">TermsFeed Privacy Policy Generator</a>.</p>\n" +
        "\n" +
        "<h2>Consent</h2>\n" +
        "\n" +
        ...
        "<h2>Log Files</h2>\n" +
        "\n" +
        "<p>treeo.org follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>\n" +
        "\n" +
        "<h2>Cookies and Web Beacons</h2>\n" +
        "\n" +
        "<p>Like any other website, treeo.org uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>\n" +
        "\n" +
        ...
        "\n" +
        "<P>You may consult this list to find the Privacy Policy for each of the advertising partners of treeo.org.</p>\n" +
        "\n" +
        "<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on treeo.org, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>\n" +
        "\n" +
        "<p>Note that treeo.org has no access to or control over these cookies that are used by third-party advertisers.</p>\n" +
        "\n" +
        "<h2>Third Party Privacy Policies</h2>\n" +
        "\n" +
        "<p>treeo.org's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </p>\n" +
        "\n" +
        ...
        "\n" +
        "<p>treeo.org does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>\n" +
"\n" +
"\n" +
"\n" +
"\n"

private const val termsOfUse = "<h2>Terms of Use</h2>\n" +
        "\n" +
        "<p>Version 1.0</p>\n" +
        "\n" +
        "<p>The Treeo App and, treeo.org website located at https://treeo.org is a copyrighted work belonging to Treeo. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>\n" +
        "\n" +
        ...
        "\n" +
        "<p><strong>Cookies and Web Beacons.</strong> Like any other website, treeo.org uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>\n" +
        "\n" +
        "\n" +
        "\n" +
        "<h2>Disclaimers</h2>\n" +
        ...
        "\n" +
        "<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Fairventures Worldwide FVW gGmbH Hasenbergstraße 31 D-70178 Stuttgart. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>\n" +
        "\n" +
        ...
        "\n" +
        "<p>Address: Fairventures Worldwide FVW gGmbH Hasenbergstraße 31 D-70178 Stuttgart</p>\n" +
        "<p>Email: info@fairventures.org</p>\n" +
        "\n" +
        "\n" +
        "\n" +
        "\n"